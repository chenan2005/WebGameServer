#include "test_s_pb_conf.h"
#include "test_s_pb_conf_session_manager.h"
#include "iod_network.h"
#include "iod_logsystem.h"

IMPLEMENT_SINGLETON_INSTANCE(test_s_pb_conf);

test_s_pb_conf::test_s_pb_conf(void)
{
}
...
bool test_s_pb_conf::initialize_server()
{
	session_manager = new test_s_pb_conf_session_manager;
...
int test_s_pb_conf::update_server()
{
...
void test_s_pb_conf::shutdown_server()
{
	if (session_manager->l_info)
...
void test_s_pb_conf::on_winsys_kbhit( int c )
{
	if (c == 'p') {
...
void test_s_pb_conf::print_help_info()
{
#ifdef WIN32
	iod_log_info("\n  q: quit server"
