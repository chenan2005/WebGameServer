...
template<typename T>
const char* IODMyTable<T>::DeleteRecord(MYSQL* pConn, const T& queryRecord, const char* pszCompareFieldNames, unsigned long* pulAffectedRows )
{
...
template<typename T>
const char* IODMyTable<T>::UpdateRecord(MYSQL* pConn, const char* pszSql, unsigned long* pulAffectedRows)
{
...
template<typename T>
const char* IODMyTable<T>::UpdateRecord(MYSQL* pConn, const T& updateRecord, const char* pszCompareFieldNames, unsigned long* pulAffectedRows, const char* pszUpdateFieldNames )
{
	char szSql[SQL_STMT_LENGTH];
	size_t size = 0;
...
template<typename T>
const char* IODMyTable<T>::QueryRecord(MYSQL* pConn, const T& queryRecord, T* pRecords, unsigned long* pulResultCount, const char* pszCompareFieldNames, unsigned long ulStart, unsigned long ulResultMaxCount )
{
	char szSql[SQL_STMT_LENGTH];
	size_t size = 0;
...
//------------------------------------------------------------------------------------------------------------------------------------------------
template<typename T>
const char* IODMyTable<T>::QueryRecord(MYSQL* pConn, const char* pszSql, T* pRecords, unsigned long* pulResultCount, unsigned long ulResultMaxCount)
{
	{
		////IODDB::STAutoTiming stAutoTiming(pszSql, 1);
		if (int iError = mysql_real_query(pConn, pszSql, (unsigned long)strlen(pszSql)))
...
template<typename T>
const char* IODMyTable<T>::QueryRecord(MYSQL* pConn, const T& queryRecord, T* pRecords, unsigned long* pulResultCount, EIODFieldKey eKeyType, unsigned long ulStart, unsigned long ulResultMaxCount)
{
	char szSql[SQL_STMT_LENGTH];
	size_t size = 0;
...
template<typename T>
const char* IODMyTable<T>::QueryRecord(MYSQL* pConn, const T& queryRecord, T* pRecords, unsigned long* pulResultCount, const char* pszCompareFieldNames, const char* pszReturnFields, unsigned long ulStart, unsigned long ulResultMaxCount )
{
	char szSql[SQL_STMT_LENGTH];
	size_t size = 0;
...
template<typename T>
const char* IODMyTable<T>::UpdateRecord(MYSQL* pConn,  const T& updateRecord, EIODFieldKey eKeyType, unsigned long* pulAffectedRows, const char* pszUpdateFieldNames )
{
...
template<typename T>
const char* IODMyTable<T>::DeleteRecord(MYSQL* pConn, const T& queryRecord, EIODFieldKey eKeyType, unsigned long* pulAffectedRows)
{
	char szSql[SQL_STMT_LENGTH];
	size_t size = 0;
...
template<typename T>
const char* IODMyTable<T>::InsertRecord(MYSQL* pConn,  const T& insertRecord, const char* pszValidFieldNames )
{
	char szSql[SQL_STMT_LENGTH];
	size_t size = 0;
