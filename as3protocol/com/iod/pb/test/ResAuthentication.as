package com.iod.pb.test {
	...
	public dynamic final class ResAuthentication extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const RESULT:FieldDescriptor_TYPE_SINT32 = new FieldDescriptor_TYPE_SINT32("com.iod.pb.test.ResAuthentication.result", "result", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const AUTHORIZATION:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.iod.pb.test.ResAuthentication.authorization", "authorization", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (result$count != 0) {
						throw new flash.errors.IOError('Bad data format: ResAuthentication.result cannot be set twice.');
					}
					++result$count;
				...
				case 2:
					if (authorization$count != 0) {
						throw new flash.errors.IOError('Bad data format: ResAuthentication.authorization cannot be set twice.');
					}
					++authorization$count;
