package com.iod.pb.test {
	...
	public dynamic final class res_authentication extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const RESULT:FieldDescriptor_TYPE_SINT32 = new FieldDescriptor_TYPE_SINT32("com.iod.pb.test.res_authentication.result", "result", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const AUTHORIZATION:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.iod.pb.test.res_authentication.authorization", "authorization", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
