package com.iod.pb.test {
	...
	public dynamic final class NotifyKickout extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const KICK_REASON:FieldDescriptor_TYPE_SINT32 = new FieldDescriptor_TYPE_SINT32("com.iod.pb.test.NotifyKickout.kick_reason", "kickReason", (1 << 3) | com.netease.protobuf.WireType.VARINT);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (kick_reason$count != 0) {
						throw new flash.errors.IOError('Bad data format: NotifyKickout.kickReason cannot be set twice.');
					}
					++kick_reason$count;
