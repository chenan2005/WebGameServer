package com.iod.pb.test {
	...
	public dynamic final class TestMsg11 extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const TEST_DATA:FieldDescriptor_TYPE_BYTES = new FieldDescriptor_TYPE_BYTES("com.iod.pb.test.TestMsg11.test_data", "testData", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (test_data$count != 0) {
						throw new flash.errors.IOError('Bad data format: TestMsg11.testData cannot be set twice.');
					}
					++test_data$count;
