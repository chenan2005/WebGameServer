package iod_pb.test {
	...
	public dynamic final class test_msg_13 extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const TEST_DATA:FieldDescriptor_TYPE_BYTES = new FieldDescriptor_TYPE_BYTES("iod_pb.test.test_msg_13.test_data", "testData", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
