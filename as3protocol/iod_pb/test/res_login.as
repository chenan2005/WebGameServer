package iod_pb.test {
	...
	public dynamic final class res_login extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const USERID:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("iod_pb.test.res_login.userid", "userid", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const RESULT:FieldDescriptor_TYPE_SINT32 = new FieldDescriptor_TYPE_SINT32("iod_pb.test.res_login.result", "result", (2 << 3) | com.netease.protobuf.WireType.VARINT);
