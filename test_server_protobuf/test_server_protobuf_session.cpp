...
void test_server_protobuf_session::on_packet( iod_packet* packet )
{
...
void test_server_protobuf_session::send_command( const char* cmd, const char* data, int data_length /*= 0*/ )
{
